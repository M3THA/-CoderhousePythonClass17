...
from Proyecto1.views import saludar , segunda_vista, dia_de_hoy, saludo_con_nombre, anio_de_nacimiento, probando_html
...
urlpatterns = [
    ...
    path("anio_de_nacimiento/<edad>", anio_de_nacimiento, name ="anio_de_nacimiento"),
